...
//        System.out.println(point3.distanceTo(point4));
//        System.out.println(point4.distanceTo(point));
...
//                    totalPerim += currDist;
//                }
//                // Adding the distance from the last point to the first point to close the shape
//                if (numberOfPoints > 1) {
//                    totalPerim += points[numberOfPoints - 1].distanceTo(points[0]);
//                }
//                return totalPerim;
//    }
//}
